...
#             raise exceptions.AuthenticationFailed1({'code': 1006, 'message': '用户认证失败！', 'data': {}})
#
...
#         auth.append('/oa/tranrecord3')
#         auth.append('/oa/uptranrecord')
#         auth.append('/oa/deldevice')
#         auth.append('/oa/exec_each_machines')
